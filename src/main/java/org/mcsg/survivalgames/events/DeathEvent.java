...
public class DeathEvent implements Listener {
	...
	public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        SurvivalGames.info(gameid, "Player died: " + player.getName() + " (" + event.getDeathMessage() + ")");
        ...
        SurvivalGames.info(gameid, "Players alive: " + StringUtils.join(alive.toArray(), ", "));
        SurvivalGames.info(gameid, "Players dead : " + StringUtils.join(dead.toArray(), ", "));
